...
class MainTabBarViewController: UITabBarController {
    ...
    func addCenterTabBarButton() {
        ...
        centerButton.setBackgroundImage(treeMapImageGray, forState: .Normal)
        ...
        let heightDifference = treeMapImageGray!.size.height - tabBar.frame.size.height
    ...
    func drawTabBarFrame() {
        ...
        let linePath = UIBezierPath(rect: CGRectMake(0, tabBar.frame.origin.y - 1, tabBar.frame.size.width, 6))
        ...
        view.layer.insertSublayer(shapeLayer, below: tabBar.layer)
